//! Cost of changing one leaf's text content in a large list: rebuild,
//! reconcile, layout, record and rasterize the changed row.
...
fn bench_single_text_change(c: &mut Criterion) {
    ...
    for &count in &[1_000usize, 10_000] {
        ...
        renderer.update(scenes::chat_with_message(count, 0, "message 0"), VIEWPORT);
